...
export class DashboardRepository {
  ...
  async getIncomeSummary(filters: DashboardFilters) {
  ...
  async getExpenseSummary(filters: DashboardFilters) {
  ...
  async getIncomesByCategory(filters: DashboardFilters) {
    const query = this.incomeRepository
      .createQueryBuilder('income')
  ...
  async getExpensesByCategory(filters: DashboardFilters) {
    const query = this.expenseRepository
      .createQueryBuilder('expense')
  ...
  async getMonthlyIncomeTrend(filters: DashboardFilters) {
    const query = this.incomeRepository
      .createQueryBuilder('income')
  ...
  async getMonthlyExpenseTrend(filters: DashboardFilters) {
    const query = this.expenseRepository
      .createQueryBuilder('expense')
  ...
  private applyIncomeDateFilters(
    query: ReturnType<
      typeof this.incomeRepository.createQueryBuilder
    >,
  ...
  private applyExpenseDateFilters(
    query: ReturnType<
      typeof this.expenseRepository.createQueryBuilder
    >,
    filters: DashboardFilters
  ) {
    if (filters.fromDate) {
