...
const JWKS = (0, jose_1.createRemoteJWKSet)(new URL(`${issuer}/.well-known/jwks.json`));
async function authMiddleware(req, res, next) {
    try {
        ...
        const { payload: accessPayload } = await (0, jose_1.jwtVerify)(accessToken, JWKS, {
            issuer,
        });
        ...
        const { payload: idPayload } = await (0, jose_1.jwtVerify)(idToken, JWKS, {
            issuer,
        });
